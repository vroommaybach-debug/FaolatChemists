  ...
  return (
    <div className="min-h-screen bg-brand-light text-brand-dark font-sans selection:bg-brand-teal/30">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-brand-navy perspective-1000">
          <motion.div 
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="bg-brand-light p-8 rounded border border-slate-200 aspect-square flex flex-col items-center justify-center text-center group hover:bg-brand-teal/5 transition-colors">
                  <Building2 className="w-10 h-10 text-brand-teal mb-4 group-hover:scale-110 transition-transform duration-500" />
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.4 }} className="bg-brand-navy p-8 rounded border border-brand-navy aspect-square flex flex-col items-center justify-center text-center text-white mt-8 group hover:bg-slate-900 transition-colors">
                  <ShieldCheck className="w-10 h-10 text-brand-gold mb-4 group-hover:scale-110 transition-transform duration-500" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <TiltCard key={i} className="h-full">
                  <div className="p-8 bg-white rounded border border-slate-200 hover:border-brand-teal transition-colors h-full flex flex-col">
        ...
        <section className="py-24 bg-white text-center border-t border-slate-200">
           <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-2xl mx-auto px-6">
             ...
             <a href="/manufacturing" className="inline-flex px-8 py-4 bg-brand-navy text-white rounded font-medium hover:bg-brand-teal transition-colors relative overflow-hidden group">
               <span className="relative z-10">Explore Manufacturing</span>
               <div className="absolute inset-0 bg-brand-teal scale-x-0 group-hover:scale-x-100 transform origin-left transition-transform duration-500 ease-out" />
             </a>
           </motion.div>
        </section>
      </main>

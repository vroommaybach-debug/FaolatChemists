  ...
  return (
    <div className="min-h-screen bg-brand-light text-brand-dark font-sans selection:bg-brand-teal/30">
      ...
      <main className="max-w-7xl mx-auto px-6 py-32">
        <div className="relative rounded overflow-hidden mb-16 bg-brand-navy border border-slate-200">
          <div className="absolute inset-0">
             <img src={catalogHeroImage} alt="Pharmacy Catalog" className="w-full h-full object-cover opacity-30 mix-blend-overlay" />
          ...
          <div className="relative z-10 px-8 py-20 md:py-32 flex flex-col items-center text-center">
            <span className="px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-brand-teal font-mono text-xs font-medium uppercase tracking-widest mb-6">Our Collection</span>
            <h1 className="text-4xl md:text-6xl font-display text-white mb-6 max-w-3xl">Pharmacy Catalog</h1>
            <p className="text-slate-300 max-w-2xl mx-auto font-light text-lg md:text-xl leading-relaxed mb-10">Explore our verified medicines, natural remedies, and health supplements, guaranteed for maximum efficacy and safety.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((product, i) => (
              <Link 
                ...
                key={product.id}
                className="group border border-slate-200 rounded bg-white overflow-hidden hover:border-brand-teal hover:shadow-xl transition-all duration-300 flex flex-col"
              >
